...
const plans = [
    {
        ...
        description:
            "For small teams who want to gain free access to our fan-favorite features.",
        features: [
            "Schedule",
            "Team Chat",
            "Assignments",
    ...
    },
    {
        ...
        description:
            "For teams wanting to also track stats and create shareable lineups.",
        features: [
    ...
    },
    {
        ...
        description:
            "For larger teams looking to monetize sponsorships and receive premium support.",
        features: [
    ...
    },
    {
        ...
        description:
            "For organizations looking to centralize their team management and save!",
        features: [
            "NEW! Program Management",
            "Club/League-wide messaging",
            "Great payment processing rates",
            "TeamSnap Ultra for all of your teams included"
        ],
