...
const feturedImages = {
    ...
    'HOCKEY': 'data:image/svg+xml;charset=UTF-8,%3Csvg xmlns="http://www.w3.org/2000/svg" width="800" height="400" viewBox="0 0 800 400"%3E%3Crect fill="%239b59b6" width="800" height="400"/%3E%3Cpath d="M300,200 L500,200 M400,120 L400,280" stroke="%23ecf0f1" stroke-width="8" fill="none"/%3E%3Ccircle cx="400" cy="200" r="60" stroke="%23ecf0f1" stroke-width="6" fill="none"/%3E%3C/svg%3E',
    'TENNIS': 'data:image/svg+xml;charset=UTF-8,%3Csvg xmlns="http://www.w3.org/2000/svg" width="800" height="400" viewBox="0 0 800 400"%3E%3Crect fill="%23f39c12" width="800" height="400"/%3E%3Cline x1="250" y1="200" x2="550" y2="200" stroke="%23ecf0f1" stroke-width="6"/%3E%3Ccircle cx="300" cy="200" r="30" stroke="%23ecf0f1" stroke-width="4" fill="none"/%3E%3Ccircle cx="500" cy="200" r="30" stroke="%23ecf0f1" stroke-width="4" fill="none"/%3E%3C/svg%3E',
};
...
const HomePage = () => {
    ...
    const loadEvents = async () => {
        try {
            const data = await store.event.fetchAll();
    ...
    const loadUpcomingEvents = async () => {
        try {
            ...
            setUpcomingEvents(data.map(event => ({
                ...event,
                image: feturedImages[event.sportType] || '',
                category: event.sportType,
    ...
    const handleTabChange = (event, newValue) => {
        ...
        const categories = ["All", "FOOTBALL", "BASKETBALL", "VOLLEYBALL", "HOCKEY", "TENNIS"];
                        ...
                        <HeroSection>
                            <HeroContent>
                                <GlassCard>
                                    ...
                                    >
                                        {featuredEvents[currentEvent] && (
                                            <>
                                                <Chip
                                                    icon={feturedIcons[featuredEvents[currentEvent].sportType]}
                                                    label={featuredEvents[currentEvent].sportType}
                                                    sx={{
                                                        backgroundColor: feturedColors[featuredEvents[currentEvent].sportType],
                                                        color: 'white',
                                                        mb: 2,
                                                        fontWeight: 'bold',
                                                        fontSize: '1rem',
                                                ...
                                                <Typography variant="h2" component="h1" sx={{ mb: 2, fontWeight: 'bold' }}>
                                                    {featuredEvents[currentEvent].eventName}
                                                </Typography>
                                                <Box sx={{ display: 'flex', justifyContent: 'center', mb: 4 }}>
                                                    ...
                                                    <Box sx={{ display: 'flex', alignItems: 'center' }}>
                                                        <LocationOn sx={{ mr: 1 }} />
                                                        <Typography>{featuredEvents[currentEvent].eventLocation}</Typography>
                                                    </Box>
                                                </Box>
                                                <CustomButton
                                                    variant="contained"
                    ...
                    >
                        ...
                        <Box sx={{ borderBottom: 1, borderColor: 'divider', mt: 4, mb: 2 }}>
                            ...
                            >
                                ...
                                <Tab label="Hockey" icon={<SportsHockey />} iconPosition="start" />
                                        ...
                                        <CardContent>
                                            ...
                                            <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                                                ...
                                                <Typography variant="body2" color="text.secondary">
                                                    {fromISOToLocal(event.eventDate)}
                                                </Typography>
                                            </Box>
                                            <Box sx={{ display: 'flex', alignItems: 'center' }}>
